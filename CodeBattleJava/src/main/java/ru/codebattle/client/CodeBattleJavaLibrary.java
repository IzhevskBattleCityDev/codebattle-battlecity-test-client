...
public class CodeBattleJavaLibrary extends WebSocketClient {
    ...
    private Consumer<Elements[][]> handler;
    ...
    public void run(Consumer<Elements[][]> handler) {
    ...
    private Elements[][] parseField(String boardString) {
        ...
        Elements[][] field = new Elements[size][size];
    ...
    private boolean isPlayerCoords(Elements e) {
        return e == Elements.TANK_DOWN
                || e == Elements.TANK_LEFT
                || e == Elements.TANK_UP
                || e == Elements.TANK_RIGHT;
    }
